...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tb3py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14531&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tb3py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tb3py` can be installed with:

```
conda install tb3py
```

It is possible to list all of the versions of `tb3py` available on your platform with:
